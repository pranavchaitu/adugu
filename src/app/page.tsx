      ...
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div className="mb-2">
          <HoverBorderGradient
            ...
            >
            <p className="text-sm font-semibold text-gray-700">Adugu is now public!</p>
          </HoverBorderGradient>
        </div>
        ...
        <p className="max-w-prose mt-5 px-4 text-zinc-700 sm:text-lg">
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 mb-4 rounded-xl bg-gray-900/5 p-2 ring ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <Image 
                    alt="product preview"
